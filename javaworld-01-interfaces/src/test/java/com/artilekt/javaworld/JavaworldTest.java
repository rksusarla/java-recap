...
public class JavaworldTest {
    ...
    public void addItemsToRoom() {
        ApartmentRoom room = new ApartmentRoom(ANTIQUE);

        assertTrue(room.decorateRoomWith(ANTIQUE_CARPET));
        assertFalse(room.decorateRoomWith(MODERN_CARPET));
        assertTrue(room.decorateRoomWith(ANTIQUE_PAINTING));
        assertFalse(room.decorateRoomWith(MODERN_PAINTING));
    }

    @Test
    public void addWashablesToLaundryLoad() {
        LaundryLoad laundryLoad = new LaundryLoad(COLORED);

        assertTrue(laundryLoad.addToLoad(ANTIQUE_CARPET));
        assertTrue(laundryLoad.addToLoad(MODERN_CARPET));
        assertFalse(laundryLoad.addToLoad(WHITE_SHIRT));
        assertFalse(laundryLoad.addToLoad(BLACK_SHIRT));
        assertTrue(laundryLoad.addToLoad(COLORED_SHIRT));
    }
